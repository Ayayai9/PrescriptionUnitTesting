...
public class Prescription {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < Prescriptions.size(); i++) {
                ...
                // separate prescriptions by two new lines
                myWriter.write("\n");
                myWriter.write("\n");
            }
            myWriter.close();
    ...
    public boolean addPrescription(int ID, String first, String last, String address, float sphere, float axis,
    	...
    	// assign function inputs to global variables
        this.prescID = ID;
     ...
     // making sure it meets assignment conditions then return true else false
